...
\def\@myTitle{PERANCANGAN APLIKASI JATIDIRI MENGGUNAKAN METODE PROTOTYPE DAN FRAMEWORK FLUTTER}
\def\@myNIM{1214070}
\def\@myName{Farel Nouval Daswara}
\def\@myYear{2026}
...
\renewcommand{\maketitle}{
    \begin{titlepage}
        ...
        \textbf{PERANCANGAN APLIKASI JATIDIRI MENGGUNAKAN METODE PROTOTYPE DAN FRAMEWORK FLUTTER}\par}
        
        \vspace{1.5cm}
        
        % Tahap Ujian Kualifikasi
        {\fontsize{12}{14}\selectfont
        \textbf{Internship 1}\par}
...
\myTitle{PERANCANGAN APLIKASI JATIDIRI MENGGUNAKAN METODE PROTOTYPE DAN FRAMEWORK FLUTTER}
\myNIM{1214070}
\myName{Farel Nouval Daswara}
\myYear{2026}
...
% BAB 3 - ANALISIS ORGANISASI PERUSAHAAN
\section*{BAB 3 \\ ANALISIS ORGANISASI PERUSAHAAN}
\phantomsection
\addcontentsline{toc}{section}{BAB 3 ANALISIS ORGANISASI PERUSAHAAN}
\refstepcounter{section}
...
\section*{BAB 4 \\ METODOLOGI PENELITIAN}
\phantomsection
\addcontentsline{toc}{section}{BAB 4 METODOLOGI PENELITIAN}
\refstepcounter{section}
...
\section*{BAB 5 \\ HASIL DAN PEMBAHASAN}
\phantomsection
\addcontentsline{toc}{section}{BAB 5 HASIL DAN PEMBAHASAN}
\refstepcounter{section}
